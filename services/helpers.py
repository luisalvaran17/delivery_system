...
def find_nearest_driver(pickup_address):
    ...
    pickup_coords = (pickup_address.longitude, pickup_address.latitude)  # ORS usa (lon, lat)
    ...
    for driver in available_drivers:
        if driver.current_address:
            ...
            try:
                ...
                distance_km = route_summary['distance'] / 1000  # metros a km
                duration_minutes = route_summary['duration'] / 60  # segundos a minutos
